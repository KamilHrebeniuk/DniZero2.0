...
const MainRouter = () => {
    ...
    return (
        <>
            ...
            <Route path="/Register">
                { isMobile ? <PopUp popUpContentType={PopUpTypes.popUpRegister}/> : <PopUp popUpContentType={PopUpTypes.popUpRegister} popUpWidth="420px"/> }
            </Route>
            <Route path="/Info">
                { isMobile ? <PopUp popUpContentType={PopUpTypes.popUpInfo}/> : <PopUp popUpContentType={PopUpTypes.popUpInfo} popUpWidth="700px"/> }
            </Route>
        </>
    )
}
