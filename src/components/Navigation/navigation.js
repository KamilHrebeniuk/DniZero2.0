    ...
    return (
        ...
        <nav className="navigation">
            <div className="navigation-element">
                ...
                <Link to="/"><img className="navigation-icon" src={ico_home} alt="HomePage"/></Link>
            </div>
            <div className="navigation-element">
                <Link to="/TimeTable"><img className="navigation-icon" src={ico_timetable} alt="TimeTable"/></Link>
            </div>
            <div className="navigation-element" >
                <Link to="/MyAccount"><img className="navigation-icon" src={ico_account} alt="MyAccount"/></Link>
            </div>
        </nav>
        ) : null
    )
